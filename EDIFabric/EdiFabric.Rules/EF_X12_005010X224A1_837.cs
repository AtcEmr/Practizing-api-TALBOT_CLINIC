namespace EdiFabric.Rules.X12005010X224A1837 {
    using System;
    ...
    [XmlElement(Order=3)]
    public string D_NM104_Pay_toAddressFirstName {get; set;}
    [XmlElement(Order=4)]
    public string D_NM105_Pay_toAddressMiddleName {get; set;}
    [XmlElement(Order=5)]
    public string D_NM106_NamePrefix {get; set;}
    [XmlElement(Order=6)]
    public string D_NM107_Pay_toAddressNameSuffix {get; set;}
    [XmlElement(Order=7)]
    public string D_NM108_IdentificationCodeQualifier {get; set;}
    [XmlElement(Order=8)]
    ...
    [XmlElement(Order=3)]
    public string D_N404_Usethealpha_2countrycodesfromPart1ofISO3166 {get; set;}
    [XmlElement(Order=4)]
    public string D_N405_LocationQualifier {get; set;}
    [XmlElement(Order=5)]
    public string D_N406_LocationIdentifier {get; set;}
    ...
    [XmlElement(Order=0)]
    public S_LX_ServiceLineCounter S_LX_ServiceLineCounter {get; set;}
    [XmlElement(Order=1)]
    ...
    [XmlType(AnonymousType=true, Namespace="www.edifabric.com/x12")]
    [XmlRoot(Namespace="www.edifabric.com/x12", IsNullable=false)]
    public class S_LX_ServiceLineCounter {
    [XmlElement(Order=0)]
    ...
    [XmlElement(Order=0)]
    public S_LX_ServiceLineCounter_2 S_LX_ServiceLineCounter_2 {get; set;}
    [XmlElement(Order=1)]
    ...
    [XmlType(AnonymousType=true, Namespace="www.edifabric.com/x12")]
    [XmlRoot(Namespace="www.edifabric.com/x12", IsNullable=false)]
    public class S_LX_ServiceLineCounter_2 {
    [XmlElement(Order=0)]
    public string D_LX01_AssignedNumber {get; set;}
    }
