namespace EdiFabric.Rules.X12005010X220834 {
    using System;
    ...
    [XmlElement(Order=5)]
    public string D_HD06_NumberofDaysofCreditablePriorCoverage {get; set;}
    [XmlElement(Order=6)]
    ...
    [XmlElement(Order=10)]
    public string D_HD11_Pre_ExistingWaivedIndicator {get; set;}
    }
    ...
    [XmlElement("S_REF_ReportingCategoryReference",Order=1)]
    public List<S_REF_ReportingCategoryReference> S_REF_ReportingCategoryReference {get; set;}
    [XmlElement(Order=2)]
