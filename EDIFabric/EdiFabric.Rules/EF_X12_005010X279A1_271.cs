namespace EdiFabric.Rules.X12005010X279A1271 {
    using System;
    ...
    [XmlElement("S_AAA_InformationReceiverRequestValidation",Order=4)]
    ...
    [XmlElement(Order=2)]
    public string D_PRV03_InformationReceiverProviderTaxonomyCode {get; set;}
    [XmlElement(Order=3)]
    ...
    public string D_PRV02_ReferenceIdentificationQualifier {get; set;}
    [XmlElement(Order=2)]
    public string D_PRV03_BenefitRelatedEntityProviderTaxonomyCode {get; set;}
    [XmlElement(Order=3)]
    public string D_PRV04_StateorProvinceCode {get; set;}
    [XmlElement(Order=4)]
