namespace EdiFabric.Templates.Hipaa5010
{
    ...
    public class Loop_2100B_277A
    {
        ...
        [Required]
        [Pos(1)]
        public NM1_InformationReceiverName_4 NM1_InformationReceiverName { get; set; }
    }
    ...
    public class Loop_2200B_277A
    {
        ...
        [Required]
        [Pos(2)]
        public List<STC_ClaimLevelStatusInformation_2> STC_InformationReceiverStatusInformation { get; set; }
        /// <summary>
    ...
    public class Loop_2200D_277A
    {
        ...
        [Required]
        [Pos(2)]
        public List<STC_ClaimLevelStatusInformation_2> STC_ClaimLevelStatusInformation { get; set; }
        /// <summary>
    ...
    public class Loop_2220D_277A
    {
        ...
        [Required]
        [Pos(1)]
        public SVC_ServiceLineInformation_3 SVC_ServiceLineInformation { get; set; }
        /// <summary>
        ...
        [Required]
        [Pos(2)]
        public List<STC_ServiceLineLevelStatusInformation> STC_ServiceLineLevelStatusInformation { get; set; }
        /// <summary>
