...
{
    internal class Other2SubscriberBuilder : ISegmentBuilder<Loop_2320_837P>
    {

        public Loop_2320_837P Build(Claim claim, ClaimOptions claimOptions)
        {
            if (claim.Other2PolicyHolderName == null)
            {
                return null;
            }
        ...
        private All_AMT_837P_2 BuildCOB(Claim claim)
        {
            ...
            {
                lst.AddRange(item.PaymentCharges.Where(i => i.InsuranceCompanyId == claim.Other2InsCompanyId));
            });
            if(lst.Count()==0)
            {
                return null;
            ...
            var totalPaidAmount = claim.InsuranceServices.Sum(p => p.PaymentCharges.Where(x => x.InsuranceCompanyId == claim.Other2InsCompanyId).Sum(c => c.PaidAmount));
            decimal adjustmentAmount = claim.InsuranceServices.Sum(p => p.PaymentCharges.Where(x => x.InsuranceCompanyId == claim.Other2InsCompanyId).Sum(c => c.PaymentAdjustments.Where(a => a.IsDenial == false).Sum(a => a.Amount)));
        ...
        private Loop_2330A_837P BuildSubscriberNameAddress(Claim claim)
        {
            return new Loop_2330A_837P
            {
                ...
                REF_OtherSubscriberSecondaryIdentification = string.IsNullOrWhiteSpace(claim.Other2PolicyNo) ? new REF_OtherSubscriberSecondaryIdentification() : null
            };
        ...
        private (N3_AdditionalPatientInformationContactAddress address, N4_AdditionalPatientInformationContactCity city) BuildSubscriberAddress(Claim claim)
        {
            ...
            {
                ResponseContactAddressLine_01 = claim.Other2PolicyHolderStreet,
            },
            new N4_AdditionalPatientInformationContactCity
            {
                AdditionalPatientInformationContactCityName_01 = claim.Other2PolicyHolderCity,
                AdditionalPatientInformationContactStateCode_02 = claim.Other2PolicyHolderState,
                AdditionalPatientInformationContactPostalZoneorZIPCode_03 = claim.Other2PolicyHolderZip
            });
        }
        ...
        private NM1_OtherSubscriberName BuildSubscriberName(Claim claim)
        {
            return new NM1_OtherSubscriberName
            {
                ...
                ResponseContactFirstName_04 = (DivideName(claim.Other2PolicyHolderName)).firstName,
                ResponseContactMiddleName_05 = "",
                ResponseContactLastorOrganizationName_03 = (DivideName(claim.Other2PolicyHolderName)).lastName,
                IdentificationCodeQualifier_08 = "MI",
                ResponseContactIdentifier_09 = claim.Other2PolicyNo,
        ...
        private Loop_2330B_837P BuildPayer(Claim claim)
        {
            ...
            return new Loop_2330B_837P
            {
                NM1_OtherPayerName = new NM1_OtherPayerName
                {
                    ...
                    ResponseContactLastorOrganizationName_03 = claim.Other2PayerName,
                    IdentificationCodeQualifier_08 = "PI",
                    ResponseContactIdentifier_09 = claim.Other2CompanyCode
                },
        ...
        private SBR_OtherSubscriberInformation BuildOtherSubscriberInformation(Claim claim)
        {
            ...
            {
                InsuranceTypeCode_05 = claim.Other2InsType,

                ClaimFilingIndicatorCode_09 = claim.Other2InsFillingCode,


                InsuredGrouporPolicyNumber_03 = claim.Other2PolicyNo,
                //OtherInsuredGroupName_04 = claim.Other2PolicyHolderGroupNo,

                PayerResponsibilitySequenceNumberCode_01 = X12_ID_1138.S.ToString(),
        ...
        private OI_OtherInsuranceCoverageInformation_2 BuildOtherInsuranceCoverage(Claim claim)
        {
            ...
            {
                BenefitsAssignmentCertificationIndicator_03 = claim.Other2PolicyHolderSignature == "Signature on File" ? "Y" : "N",
                ReleaseofInformationCode_06 = claim.Other2PatientSignatureOnFile == "Signature on File" ? "Y" : "N"
            };
        }
        ...
        private string GetRelationship(Claim claim)
        {
            ...
            RelationshipType relationshipType = (RelationshipType)claim.Other2PolicyHolderRelation;
