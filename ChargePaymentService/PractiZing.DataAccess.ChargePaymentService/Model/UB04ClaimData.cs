...
{
    public class UB04ClaimData : IInsuranceClaimData
    {
        public UB04ClaimData(IClaim claim)
        {
            _claim = claim;
            Services = _claim.InsuranceServices.Select(x => new InsuranceService(x, _claim.GRP, claim.BillingFacilityNPI)).ToArray(); ;
        }
        ...
        public string PatientFullName => _claim.PatientName;
        ...
        public string PayerName => _claim.PayerName;
        ...
        public string DateMade => _claim.ClaimDate.AddDays(-4).ToString("MM dd yyyy");
        ...
        public DateTime? CurrentIllnesDate => null;
        ...
        public DatePeriod Hospitalization => new DatePeriod(_claim.HospitalizationFrom.Value, _claim.HospitalizationTo.Value);

        public string AdditionalInformation => _claim.ClaimTotal.Reserved19;

        public bool OutsideLab => _claim.ClaimTotal.OutsideLab;

        public decimal? OutsideLabCharge => Convert.ToDecimal(_claim.ClaimTotal.LabCharges);
        ...
        public string PriorAuthorizationNumber => _claim.ClaimTotal.PriorAuthorizationNumber;

        public IInsuranceService[] Services { get; private set; }

        public string FederalTaxIdNumber => _claim.FederalTaxIDNumber;

        //public string TaxNumberType => Enum.GetName(typeof(TaxIdType), _claim.Providers.BillingProvider.Details.TaxIdType);
        public string TaxNumberType => "EmployerIdentitificationNumber";


        public string PatientAccountNumber => _claim.CaseIdNumber;
        ...
        public string ServiceFacilityStreet => _claim.PerformingLocationAddressLine1;

        public string ServiceFacilityLocation => $"{_claim.PerformingLocationCity} {_claim.PerformingLocationState} {_claim.PerformingLocationZIP}";

        public string ServiceFacilityNpi => _claim.PerformingFacilityNPI;

        public string ClaimFacilityNpi => _claim.FacilityId;
        ...
        public string BillingProviderCity => _claim.BillingDoctorCity;
        public string BillingProviderState => _claim.BillingDoctorState;

        public string BillingProviderZIP => _claim.BillingDoctorZip;
        ...
        public string BillingProviderNpi => _claim.BillingFacilityId;
        ...
        public string BillingProviderDetails => "0";
